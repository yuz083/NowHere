                        ...
                        <div class="ibox-content">
                            <form role="form" id="form" method="POST" action="ad_update.php">
								...
								<div class="form-group  row"><label class="col-sm-2 col-form-label">시작일</label>
                                    <div class="col-md-4"><input type="text" class="form-control" name="Start_Date" value="<?=$row["Start_Date"]?>"></div>
									<label class="col-sm-2 col-form-label">종료일</label>
                                    <div class="col-md-4"><input type="text" class="form-control" name="End_Date" value="<?=$row["End_Date"]?>"></div>
								</div>
