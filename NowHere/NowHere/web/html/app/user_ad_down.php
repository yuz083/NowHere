                                    ...
                                    <tr>
                                      ...
                                      <!--  <td class="project-completion">
                                        ...
                                        <td class="project-people">
                                           <small> <?=substr($row["Start_Date"],2,13) ?> ~ <?=substr($row["End_Date"],2,13) ?> </small>
                                        </td>
                                        <td class="project-actions">
                                            
                                            <button type="button" class="btn btn-white btn-sm" data-toggle="modal" data-target="#myModal" data-whatever = "<?=$row["Event_No"]?>"><i class="fa fa-search"></i></a>
                                        </td>
                                    </tr>
                                    <?php
                                                }
