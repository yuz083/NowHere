        ...
        <div>
            ...
            <div class="ibox ">
				<div class="ibox-content">
					<form  class="m-t" role="form" method="post" id="register" name="register" action="signup_process.php">						
						<div class="form-group  row">
							<div class="col-sm-4"><input type="text" id ="User_ID" name="User_ID" placeholder="ID" class="form-control"></div>
							<div><button type="button" class="btn btn-outline btn-primary" id="btnCheck">중복확인</button></div>
							<input type="hidden" id="idchecked" name="idchecked">
						</div>
						<div class="form-group  row">
							<div class="col-sm-7"><input type="password" class="form-control" placeholder="암호" id="Passwd" name="Passwd"></div>
						</div>
						<div class="form-group  row">
							<div class="col-sm-7"><input type="password" class="form-control"   placeholder="암호확인" id="ConfirmPwd" name="ConfirmPwd"></div>
						</div>
						<div class="form-group  row">
							<div class="col-sm-7"><input type="text" class="form-control" placeholder="이름" id="Mem_Name" name="Mem_Name"></div>
						</div>
						<div class="form-group  row">
							<div class="col-sm-7"><input type="text" class="form-control" placeholder="이메일" id="Email" name="Email"></div>
						</div>
						<div class="form-group  row">
							<div class="col-sm-7"><input type="text" class="form-control" placeholder="휴대폰번호" id="Cell_Phone" name="Cell_Phone">
							</div>
						</div>
						<div class="form-group  row">
							...
							<div class="col-sm-5">
								<select class="form-control birth-group" placeholder="생년" style="display: inline-block; width: 35%;" id="b_year" name="b_year">
	                              	<option value="n">생년</option>
	                              	<?php
	                              		for ($i=2010; $i> 1950; $i--)
	                              		{
								...
								<select  class="form-control birth-group" style="display: inline-block; width: 30%;" id="b_month" name="b_month">
								...
								<select  class="form-control birth-group" style="display: inline-block; width: 30%;" id="b_day" name="b_day">
							...
							<div class="btn-group col-sm-2"><select class="form-control m-b" name="Gender">
                              	<option value="1" selected= "selected">남</option>
						...
						<div class="form-group  row">						
							...
							<div ><button type="button" onclick="execDaumPostcode()" class="btn btn-outline btn-primary">찾아보기</button> 
							</div>
						...
						<div class="form-group  row">
							<div class="col-sm-9"><div class="checkbox i-checks"><label><input type="checkbox"  class="form-control" id="agree" name="agree"><i></i> 약관에 동의 </label></div></div>
						</div>
