<?php
		...
		$sql = "INSERT INTO Event (Mem_No, Category_No, Reg_Name, Event_Name, Event_Type_Code, Event_Content, Event_Contact_No, Start_Date, End_Date, Place_X,Place_Y, Pub_Coupon_Cnt, Target_Gender, Target_Age, Reg_Date, Radius) VALUES ('$Mem_No', '$Category_No', '$Reg_Name', '$Event_Name', '$Event_Type_No', '$Event_Content', '$Event_Contact_No', '$Start_Date', '$End_Date', '$Place_X','$Place_Y', '$Pub_Coupon_Cnt', '$Target_Gender', '$Target_Age', NOW(), '$Radius')";
