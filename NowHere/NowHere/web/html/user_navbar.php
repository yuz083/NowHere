<?php
		...
		if (empty($_SESSION["Mem_Name"]))
		{
			$userid="";
		}
		else
		{
			$userid=$_SESSION["Mem_Name"];
		}
?>
<script>
...
<nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="block m-t-xs font-bold"><?=$userid?></span>
				...
				<li class="active">
                    <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">광고 이벤트</span> </a>
                    <ul class="nav nav-second-level">
					    <li><a href="user_ad_list.php">진행중인 전체 이벤트</a></li>
                        
                        <li><a href="#" onclick="javascript:onAdlistByPos();">내 주변 이벤트</a></li>
              
                        <li><a href="user_ad_down.php">쿠폰 보관함</a></li>
					</ul>
                </li>
