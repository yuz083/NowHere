                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <td class="project-completion">
                                                <small>다운로드 수: <?=$row["cnt"]?>/<?=$row["Pub_Coupon_Cnt"]?>(<?=ceil($row["cnt"]/$row["Pub_Coupon_Cnt"]*100)?>%)</small>
                                        ...
                                        <td class="project-actions">
                                           <button id="push_<?=$row["Event_No"]?>" class="btn btn-white btn-sm" data-whatever="<?=$row["Event_No"]?>"><i class="fa fa-bullhorn"></i>PUSH</button>
                                        </td>
                                    </tr>
                                    <?php
												}
